...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a7cd0ba2-a674-496f-b614-f2b5ce818ac4
```

> `a7cd0ba2-a674-496f-b614-f2b5ce818ac4` is the password of the certificate, you can change it to any password you want.
